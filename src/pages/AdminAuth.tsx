...
export default function AdminAuth() {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-[#070918] px-4 py-7 text-white sm:flex sm:items-center sm:justify-center sm:px-5 sm:py-4">
      ...
      <Card className="relative z-10 mx-auto w-full max-w-[600px] overflow-hidden rounded-[27px] border border-[#756292]/45 bg-[linear-gradient(145deg,rgba(24,24,50,.94),rgba(9,12,29,.97)_58%,rgba(18,16,42,.95))] text-white shadow-[0_0_0_1px_rgba(183,112,255,.07),0_0_38px_rgba(126,48,218,.22),0_35px_100px_rgba(0,0,0,.42)] before:pointer-events-none before:absolute before:inset-0 before:rounded-[27px] before:bg-[radial-gradient(circle_at_7%_2%,rgba(231,128,255,.2),transparent_12%),radial-gradient(circle_at_100%_100%,rgba(194,80,255,.10),transparent_15%)] animate-fade-in">
        ...
        <CardHeader className="relative px-6 pb-0 pt-8 text-center sm:px-11 sm:pt-6">
          <div className="relative mx-auto mb-3 flex h-[150px] w-full max-w-[340px] items-center justify-center sm:mb-2 sm:h-[110px] sm:max-w-[280px]">
            <div className="absolute h-24 w-56 rounded-full bg-violet-600/20 blur-[42px]" />
            <img
              src={vegSystemLogo}
              alt="VEG System"
              className="absolute h-auto w-[360px] max-w-none sm:w-[330px]"
              style={{ filter: 'drop-shadow(0 0 10px rgba(185,82,255,.75)) drop-shadow(0 0 28px rgba(112,38,221,.42))' }}
            />
          </div>

          <div className="mb-2 flex items-center justify-center gap-3 sm:mb-1 sm:gap-3.5">
            <Shield className="h-9 w-9 shrink-0 stroke-[1.8] text-[#b54cff] sm:h-9 sm:w-9" />
            <CardTitle className="text-[29px] font-bold tracking-[-0.025em] text-[#f6f4fb] sm:text-[34px]">
              Área Administrativa
            </CardTitle>
          </div>
          <CardDescription className="text-base font-normal tracking-[0.01em] text-[#aca9c1] sm:text-[18px]">
            Acesso exclusivo para colaboradores autorizados
          </CardDescription>

          <div className="mx-auto mt-4 inline-flex min-h-10 items-center justify-center gap-3 rounded-full border border-[#9e4ace]/50 bg-[#17152d]/80 px-5 text-sm text-[#ded9e9] sm:mt-2.5 sm:min-h-9 sm:px-4 sm:text-sm">
        ...
        <CardContent className="relative px-6 pb-7 pt-7 sm:px-11 sm:pb-[18px] sm:pt-4">
          {showForgotPassword ? (
            <form onSubmit={handleForgotPassword} className="space-y-6 sm:space-y-4">
              <div className="space-y-3 sm:space-y-1.5">
                <Label htmlFor="forgot-email" className="text-base font-semibold text-[#f5f2fa]">Email corporativo</Label>
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className="h-[66px] rounded-2xl border-[#685484]/75 bg-[#121426]/80 pl-14 text-base text-white shadow-inner placeholder:text-[#767389] focus-visible:border-[#b75dff] focus-visible:ring-2 focus-visible:ring-[#9d42e8]/25 sm:h-14"
              ...
              <Button 
                type="submit" 
                className="h-[68px] w-full rounded-2xl border-0 bg-[linear-gradient(100deg,#7629f5_0%,#b528f2_50%,#f11bc9_100%)] text-lg font-bold text-white shadow-[0_10px_28px_rgba(157,36,238,.28)] transition hover:brightness-110 sm:h-[58px]"
                disabled={forgotLoading}
              >
                {forgotLoading ? (
                  <>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-4">
              <div className="space-y-3 sm:space-y-1.5">
                <Label htmlFor="email" className="text-base font-semibold text-[#f5f2fa]">Email corporativo</Label>
                <div className="relative group">
                  <Mail className="absolute left-5 top-1/2 h-5 w-5 -translate-y-1/2 text-[#bd5dff] transition-colors group-focus-within:text-[#db9bff]" />
                  <Input
                    id="email"
                    ...
                    className={`h-[66px] rounded-2xl border-[#685484]/75 bg-[#121426]/80 pl-14 text-base text-white shadow-inner placeholder:text-[#767389] focus-visible:border-[#b75dff] focus-visible:ring-2 focus-visible:ring-[#9d42e8]/25 sm:h-14 ${errors.email ? 'border-red-500' : ''}`}
                    disabled={isLoading}
                    autoComplete="email"
                  />
                </div>
              ...
              <div className="space-y-3 sm:space-y-1.5">
                <Label htmlFor="password" className="text-base font-semibold text-[#f5f2fa]">Senha</Label>
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className={`h-[66px] rounded-2xl border-[#685484]/75 bg-[#121426]/80 px-14 text-base text-white shadow-inner placeholder:text-[#b8b4c8] focus-visible:border-[#b75dff] focus-visible:ring-2 focus-visible:ring-[#9d42e8]/25 sm:h-14 ${errors.password ? 'border-red-500' : ''}`}
                    disabled={isLoading}
              ...
              <Button 
                type="submit" 
                className="mt-1 h-[68px] w-full rounded-2xl border-0 bg-[linear-gradient(100deg,#7629f5_0%,#b528f2_50%,#f11bc9_100%)] text-lg font-bold text-white shadow-[0_10px_28px_rgba(157,36,238,.28)] transition hover:brightness-110 sm:h-[58px]"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
              ...
              <button
                ...
                className="w-full pt-0 text-base font-medium text-[#c45cff] transition hover:text-[#df91ff] hover:underline"
              >
                Esqueci minha senha
              </button>
            </form>
          ...
          <div className="mt-5 border-t border-[#615c76]/45 py-5 sm:mt-3.5 sm:py-3">
            <div className="flex items-center justify-center gap-4 text-center text-sm leading-relaxed text-[#aaa6bd] sm:gap-3 sm:text-left">
              <Headphones className="h-7 w-7 shrink-0 text-[#bd58ff] sm:h-6 sm:w-6" />
          ...
          <footer className="flex items-center gap-4 border-t border-[#615c76]/55 pt-5 text-[#aaa6bd] sm:gap-3 sm:pt-3">
            <div className="relative h-12 w-12 shrink-0 overflow-hidden sm:h-10 sm:w-10" aria-hidden="true">
              <img src={vegSystemLogo} alt="" className="absolute -left-[12px] -top-[53px] h-auto w-[150px] max-w-none sm:-left-[10px] sm:-top-[44px] sm:w-[125px]" style={{ filter: 'drop-shadow(0 0 6px rgba(180,76,255,.55))' }} />
            </div>
