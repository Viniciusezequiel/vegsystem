...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex w-max min-w-full flex-nowrap items-center justify-start gap-1 overflow-x-auto overflow-y-hidden rounded-md bg-muted p-1 text-muted-foreground scrollbar-none",
      className,
    )}
