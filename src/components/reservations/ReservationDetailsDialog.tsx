...
import { Check, X, Calendar, Clock, Users, Mail, Phone, MapPin, Building, Trash2, RefreshCw } from 'lucide-react';
...
export function ReservationDetailsDialog({ reservation, open, onOpenChange }: ReservationDetailsDialogProps) {
  ...
  const canReschedule = reservation.status !== 'cancelled' && reservation.status !== 'completed';
