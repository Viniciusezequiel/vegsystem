-- ============================================================
-- ACHADOS E PERDIDOS — BUSCA INTELIGENTE V2 / PRECISION FIRST
--
-- Mantem a interface publica da RPC e os filtros existentes.
-- Estrategia:
-- 1. strong_matches: substring normalizada / sinonimos exatos.
-- 2. fuzzy_matches: somente se nenhum strong_match VISIVEL existir.
--
-- Importante: base e avaliada sob SECURITY INVOKER, portanto RLS e
-- filtros sao aplicados antes da decisao de suprimir o fallback fuzzy.
-- Um strong match oculto por RLS nao bloqueia resultados visiveis.
--
-- Regressao alvo:
--   terco -> Terco (forte), sem termica/terreo
--   terso -> Terco (fallback fuzzy)
-- ============================================================
