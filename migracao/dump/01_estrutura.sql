...
DO $$ BEGIN ALTER TABLE public.activity_logs ADD CONSTRAINT activity_logs_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.app_settings ADD CONSTRAINT app_settings_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.app_settings ADD CONSTRAINT app_settings_key_key UNIQUE (key); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.checklist_answers ADD CONSTRAINT checklist_answers_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.checklist_questions ADD CONSTRAINT checklist_questions_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.classroom_call_responses ADD CONSTRAINT classroom_call_responses_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.classroom_call_room_issues ADD CONSTRAINT classroom_call_room_issues_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.classroom_call_rooms ADD CONSTRAINT classroom_call_rooms_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.classroom_calls ADD CONSTRAINT classroom_calls_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.equipment ADD CONSTRAINT equipment_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.equipment ADD CONSTRAINT equipment_patrimony_code_key UNIQUE (patrimony_code); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.equipment_loans ADD CONSTRAINT equipment_loans_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.equipment_reservations ADD CONSTRAINT equipment_reservations_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.external_equipment_requests ADD CONSTRAINT external_equipment_requests_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'approved'::text, 'rejected'::text, 'awaiting_pickup'::text, 'loaned'::text, 'returned'::text]))); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.external_equipment_requests ADD CONSTRAINT external_equipment_requests_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.external_users ADD CONSTRAINT external_users_user_type_check CHECK ((user_type = ANY (ARRAY['professor'::text, 'colaborador'::text]))); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.external_users ADD CONSTRAINT external_users_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.external_users ADD CONSTRAINT external_users_user_id_key UNIQUE (user_id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.inventory_movements ADD CONSTRAINT inventory_movements_movement_type_check CHECK ((movement_type = ANY (ARRAY['transfer'::text, 'write_off'::text, 'import'::text, 'adjustment'::text]))); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.inventory_movements ADD CONSTRAINT inventory_movements_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.locker_exchanges ADD CONSTRAINT locker_exchanges_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.locker_loans ADD CONSTRAINT locker_loans_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.lockers ADD CONSTRAINT lockers_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.lockers ADD CONSTRAINT lockers_code_key UNIQUE (code); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.lost_items ADD CONSTRAINT lost_items_status_check CHECK ((status = ANY (ARRAY['available'::text, 'pending'::text, 'delivered'::text, 'expired'::text]))); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.lost_items ADD CONSTRAINT lost_items_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.lost_items ADD CONSTRAINT lost_items_code_key UNIQUE (code); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.lost_items_archive ADD CONSTRAINT lost_items_archive_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.material_requests ADD CONSTRAINT material_requests_priority_check CHECK ((priority = ANY (ARRAY['low'::text, 'normal'::text, 'high'::text, 'urgent'::text]))); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.material_requests ADD CONSTRAINT material_requests_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'approved'::text, 'rejected'::text, 'delivered'::text]))); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.material_requests ADD CONSTRAINT material_requests_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.profiles ADD CONSTRAINT profiles_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.profiles ADD CONSTRAINT profiles_user_id_key UNIQUE (user_id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_campus_floors ADD CONSTRAINT ps_campus_floors_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_campuses ADD CONSTRAINT ps_campuses_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_candidates ADD CONSTRAINT ps_candidates_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_collaborators ADD CONSTRAINT ps_collaborators_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_evaluation_retifications ADD CONSTRAINT ps_evaluation_retifications_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_evaluations ADD CONSTRAINT ps_evaluations_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_event_collaborators ADD CONSTRAINT ps_event_collaborators_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_events ADD CONSTRAINT ps_events_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_fiscal_bank_applications ADD CONSTRAINT ps_fiscal_bank_applications_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_fiscal_bank_config ADD CONSTRAINT ps_fiscal_bank_config_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_general_evaluations ADD CONSTRAINT ps_general_evaluations_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_roles ADD CONSTRAINT ps_roles_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_roles ADD CONSTRAINT ps_roles_value_key UNIQUE (value); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_self_evaluations ADD CONSTRAINT ps_self_evaluations_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservation_logs ADD CONSTRAINT reservation_logs_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservation_reschedulings ADD CONSTRAINT reservation_reschedulings_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservation_rooms ADD CONSTRAINT reservation_rooms_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservation_rooms ADD CONSTRAINT reservation_rooms_code_key UNIQUE (code); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservations ADD CONSTRAINT reservations_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'confirmed'::text, 'cancelled'::text, 'completed'::text]))); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservations ADD CONSTRAINT reservations_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.role_permissions ADD CONSTRAINT role_permissions_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.role_permissions ADD CONSTRAINT role_permissions_role_module_action_key UNIQUE (role, module, action); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.room_checklists ADD CONSTRAINT room_checklists_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.room_combinations ADD CONSTRAINT room_combinations_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.room_combinations ADD CONSTRAINT room_combinations_parent_room_id_linked_room_id_key UNIQUE (parent_room_id, linked_room_id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.rooms ADD CONSTRAINT rooms_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_checklist_items ADD CONSTRAINT semester_checklist_items_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_checklists ADD CONSTRAINT semester_checklists_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_competencies ADD CONSTRAINT semester_competencies_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_furniture_details ADD CONSTRAINT semester_furniture_details_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_item_options ADD CONSTRAINT semester_item_options_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_item_options ADD CONSTRAINT semester_item_options_category_label_key UNIQUE (category, label); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_labels ADD CONSTRAINT semester_labels_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_labels ADD CONSTRAINT semester_labels_label_code_key UNIQUE (label_code); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_projectors ADD CONSTRAINT semester_projectors_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.shift_handover_incidents ADD CONSTRAINT shift_handover_incidents_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.shift_handover_tasks ADD CONSTRAINT shift_handover_tasks_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.shift_handovers ADD CONSTRAINT shift_handovers_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.task_comments ADD CONSTRAINT task_comments_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.task_history ADD CONSTRAINT task_history_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.task_team_members ADD CONSTRAINT task_team_members_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.task_team_members ADD CONSTRAINT task_team_members_task_id_user_id_key UNIQUE (task_id, user_id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.tasks ADD CONSTRAINT tasks_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.uber_requests ADD CONSTRAINT uber_requests_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.uber_requests ADD CONSTRAINT uber_requests_code_key UNIQUE (code); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.user_roles ADD CONSTRAINT user_roles_pkey PRIMARY KEY (id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.user_roles ADD CONSTRAINT user_roles_user_id_role_key UNIQUE (user_id, role); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;

-- ============ FOREIGN KEYS ============

DO $$ BEGIN ALTER TABLE public.checklist_answers ADD CONSTRAINT checklist_answers_checklist_id_fkey FOREIGN KEY (checklist_id) REFERENCES room_checklists(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.checklist_answers ADD CONSTRAINT checklist_answers_question_id_fkey FOREIGN KEY (question_id) REFERENCES checklist_questions(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.classroom_call_room_issues ADD CONSTRAINT classroom_call_room_issues_room_id_fkey FOREIGN KEY (room_id) REFERENCES classroom_call_rooms(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.classroom_calls ADD CONSTRAINT classroom_calls_accepted_by_fkey FOREIGN KEY (accepted_by) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.equipment ADD CONSTRAINT equipment_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.equipment_loans ADD CONSTRAINT equipment_loans_equipment_id_fkey FOREIGN KEY (equipment_id) REFERENCES equipment(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.equipment_loans ADD CONSTRAINT equipment_loans_loaned_by_fkey FOREIGN KEY (loaned_by) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.equipment_loans ADD CONSTRAINT equipment_loans_returned_by_fkey FOREIGN KEY (returned_by) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.equipment_reservations ADD CONSTRAINT equipment_reservations_equipment_id_fkey FOREIGN KEY (equipment_id) REFERENCES equipment(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.external_equipment_requests ADD CONSTRAINT external_equipment_requests_equipment_id_fkey FOREIGN KEY (equipment_id) REFERENCES equipment(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.inventory_movements ADD CONSTRAINT inventory_movements_equipment_id_fkey FOREIGN KEY (equipment_id) REFERENCES equipment(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.locker_exchanges ADD CONSTRAINT locker_exchanges_new_loan_id_fkey FOREIGN KEY (new_loan_id) REFERENCES locker_loans(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.locker_exchanges ADD CONSTRAINT locker_exchanges_new_locker_id_fkey FOREIGN KEY (new_locker_id) REFERENCES lockers(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.locker_exchanges ADD CONSTRAINT locker_exchanges_old_loan_id_fkey FOREIGN KEY (old_loan_id) REFERENCES locker_loans(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.locker_exchanges ADD CONSTRAINT locker_exchanges_old_locker_id_fkey FOREIGN KEY (old_locker_id) REFERENCES lockers(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.locker_exchanges ADD CONSTRAINT locker_exchanges_performed_by_fkey FOREIGN KEY (performed_by) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.locker_loans ADD CONSTRAINT locker_loans_loaned_by_fkey FOREIGN KEY (loaned_by) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.locker_loans ADD CONSTRAINT locker_loans_locker_id_fkey FOREIGN KEY (locker_id) REFERENCES lockers(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.locker_loans ADD CONSTRAINT locker_loans_returned_by_fkey FOREIGN KEY (returned_by) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.lost_items ADD CONSTRAINT lost_items_delivered_by_team_member_fkey FOREIGN KEY (delivered_by_team_member) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.lost_items ADD CONSTRAINT lost_items_registered_by_fkey FOREIGN KEY (registered_by) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.material_requests ADD CONSTRAINT material_requests_assigned_to_fkey FOREIGN KEY (assigned_to) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.profiles ADD CONSTRAINT profiles_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_campus_floors ADD CONSTRAINT ps_campus_floors_campus_id_fkey FOREIGN KEY (campus_id) REFERENCES ps_campuses(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_candidates ADD CONSTRAINT ps_candidates_event_id_fkey FOREIGN KEY (event_id) REFERENCES ps_events(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_evaluation_retifications ADD CONSTRAINT ps_evaluation_retifications_collaborator_id_fkey FOREIGN KEY (collaborator_id) REFERENCES ps_collaborators(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_evaluation_retifications ADD CONSTRAINT ps_evaluation_retifications_evaluation_id_fkey FOREIGN KEY (evaluation_id) REFERENCES ps_evaluations(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_evaluation_retifications ADD CONSTRAINT ps_evaluation_retifications_event_id_fkey FOREIGN KEY (event_id) REFERENCES ps_events(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_evaluations ADD CONSTRAINT ps_evaluations_collaborator_id_fkey FOREIGN KEY (collaborator_id) REFERENCES ps_collaborators(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_evaluations ADD CONSTRAINT ps_evaluations_event_id_fkey FOREIGN KEY (event_id) REFERENCES ps_events(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_event_collaborators ADD CONSTRAINT ps_event_collaborators_collaborator_id_fkey FOREIGN KEY (collaborator_id) REFERENCES ps_collaborators(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_event_collaborators ADD CONSTRAINT ps_event_collaborators_event_id_fkey FOREIGN KEY (event_id) REFERENCES ps_events(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_general_evaluations ADD CONSTRAINT ps_general_evaluations_collaborator_id_fkey FOREIGN KEY (collaborator_id) REFERENCES ps_collaborators(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.ps_self_evaluations ADD CONSTRAINT ps_self_evaluations_event_id_fkey FOREIGN KEY (event_id) REFERENCES ps_events(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservation_logs ADD CONSTRAINT reservation_logs_reservation_id_fkey FOREIGN KEY (reservation_id) REFERENCES reservations(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservation_logs ADD CONSTRAINT reservation_logs_room_id_fkey FOREIGN KEY (room_id) REFERENCES reservation_rooms(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservation_reschedulings ADD CONSTRAINT reservation_reschedulings_new_room_id_fkey FOREIGN KEY (new_room_id) REFERENCES reservation_rooms(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservation_reschedulings ADD CONSTRAINT reservation_reschedulings_original_room_id_fkey FOREIGN KEY (original_room_id) REFERENCES reservation_rooms(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservation_reschedulings ADD CONSTRAINT reservation_reschedulings_rescheduled_by_fkey FOREIGN KEY (rescheduled_by) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservation_reschedulings ADD CONSTRAINT reservation_reschedulings_reservation_id_fkey FOREIGN KEY (reservation_id) REFERENCES reservations(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservations ADD CONSTRAINT reservations_external_user_id_fkey FOREIGN KEY (external_user_id) REFERENCES external_users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.reservations ADD CONSTRAINT reservations_room_id_fkey FOREIGN KEY (room_id) REFERENCES reservation_rooms(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.room_checklists ADD CONSTRAINT room_checklists_filled_by_fkey FOREIGN KEY (filled_by) REFERENCES auth.users(id); EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.room_checklists ADD CONSTRAINT room_checklists_room_id_fkey FOREIGN KEY (room_id) REFERENCES rooms(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.room_combinations ADD CONSTRAINT room_combinations_linked_room_id_fkey FOREIGN KEY (linked_room_id) REFERENCES reservation_rooms(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.room_combinations ADD CONSTRAINT room_combinations_parent_room_id_fkey FOREIGN KEY (parent_room_id) REFERENCES reservation_rooms(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_checklist_items ADD CONSTRAINT semester_checklist_items_checklist_id_fkey FOREIGN KEY (checklist_id) REFERENCES semester_checklists(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_checklists ADD CONSTRAINT semester_checklists_competency_id_fkey FOREIGN KEY (competency_id) REFERENCES semester_competencies(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_checklists ADD CONSTRAINT semester_checklists_room_id_fkey FOREIGN KEY (room_id) REFERENCES reservation_rooms(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_furniture_details ADD CONSTRAINT semester_furniture_details_checklist_item_id_fkey FOREIGN KEY (checklist_item_id) REFERENCES semester_checklist_items(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_item_options ADD CONSTRAINT semester_item_options_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users(id) ON DELETE SET NULL; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_labels ADD CONSTRAINT semester_labels_checklist_item_id_fkey FOREIGN KEY (checklist_item_id) REFERENCES semester_checklist_items(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_labels ADD CONSTRAINT semester_labels_competency_id_fkey FOREIGN KEY (competency_id) REFERENCES semester_competencies(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_labels ADD CONSTRAINT semester_labels_furniture_detail_id_fkey FOREIGN KEY (furniture_detail_id) REFERENCES semester_furniture_details(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.semester_projectors ADD CONSTRAINT semester_projectors_checklist_id_fkey FOREIGN KEY (checklist_id) REFERENCES semester_checklists(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.shift_handover_incidents ADD CONSTRAINT shift_handover_incidents_handover_id_fkey FOREIGN KEY (handover_id) REFERENCES shift_handovers(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.shift_handover_tasks ADD CONSTRAINT shift_handover_tasks_handover_id_fkey FOREIGN KEY (handover_id) REFERENCES shift_handovers(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.task_comments ADD CONSTRAINT task_comments_task_id_fkey FOREIGN KEY (task_id) REFERENCES tasks(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.task_history ADD CONSTRAINT task_history_task_id_fkey FOREIGN KEY (task_id) REFERENCES tasks(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.task_team_members ADD CONSTRAINT task_team_members_task_id_fkey FOREIGN KEY (task_id) REFERENCES tasks(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE public.user_roles ADD CONSTRAINT user_roles_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE; EXCEPTION WHEN duplicate_table THEN NULL WHEN duplicate_object THEN NULL WHEN invalid_table_definition THEN NULL; END $$;
